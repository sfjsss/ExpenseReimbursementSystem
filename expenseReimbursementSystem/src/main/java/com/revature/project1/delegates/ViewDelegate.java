...
public class ViewDelegate {
	...
	public void resolveView(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/manager-profile":
			request.getRequestDispatcher("/static/Views/managerProfileEdit.html").forward(request, response);
			break;
		case "/view-employees":
		...
		case "/employee-profile":
			...
			break;
		case "/employee-stats":
			request.getRequestDispatcher("/static/Views/employeeChart.html").forward(request, response);
			break;
		case "/":
